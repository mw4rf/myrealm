...
public class WorldSoldier {
    ...
    public WorldSoldier(String name) {
        super();
        this.name = name;
    }

    public WorldSoldier(String name, List<WorldGood> goods) {
        super();
        this.name = name;
        this.goods = goods;
    }
    ...
    /**
     * Get the real number of soldiers that can be trained each cycle
     * 
    ...
    /**
     * Get the list of goods not produced by the player, and needed to train that soldier
     * 
